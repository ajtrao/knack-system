...
class EmployersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create employer" do
    assert_difference("Employer.count") do
      post employers_url, params: { employer: { age: @employer.age, department: @employer.department, email: @employer.email, name: @employer.name, salary: @employer.salary } }
    end
  ...
  test "should update employer" do
    patch employer_url(@employer), params: { employer: { age: @employer.age, department: @employer.department, email: @employer.email, name: @employer.name, salary: @employer.salary } }
